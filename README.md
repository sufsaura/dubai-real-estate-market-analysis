...
*(Add your 4 page screenshots here, e.g.:)*

```
![Market Overview](screenshots/page1_market_overview.png)
![Market Segments](screenshots/page2_market_segments.png)
![Metro & Location Insights](screenshots/page3_metro_insights.png)
![Investor Summary](screenshots/page4_investor_summary.png)
```
